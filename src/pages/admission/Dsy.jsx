...
const Dsy = () => {
  ...
  const storeData = async () => {
    ...
    try {
      const admissionDsyCollection = collection(db, 'admissionDsy');
      await addDoc(admissionDsyCollection, formData);
  ...
  return (
    <div className='enquiry-main'>
      <div className='enquiry'>
        <div className='form-title'>Direct Second Admission form</div>
        <Form layout="vertical" onFinish={storeData}>
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item label="Diploma Passout Year">
                <Input
                  name='year'
                  value={formData.year}
          ...
          <Row gutter={16}>
            ...
            <Col span={12}>
              <Form.Item label="Deploma Percentage">
                <Input
